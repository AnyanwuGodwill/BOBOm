                ...
                <tr>
                    <td>
                        <?php if (!empty($key['image'])) { ?>
                            <img src="../uploads/categories/<?php echo $key['image']; ?>" alt="Category Image" width="50" height="50" style="border-radius: 5px;">
                        <?php } else { ?>
                            <span>No Image</span>
                        <?php } ?>
                    </td>
                    <td><?php echo htmlspecialchars($key['name']); ?></td>
                    <td><?php echo htmlspecialchars($key['short_desc']); ?></td>
                    <td><?php echo htmlspecialchars($key['long_desc']); ?></td>
                    <td>
                        <a href="../backends/admin/cat-delete.php?id=<?php echo $key['id']; ?>" onclick="return confirm('Are you sure you want to delete this category?');">
